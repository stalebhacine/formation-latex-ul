\documentclass[aspectratio=54,10pt,xcolor=x11names]{beamer}
  ...
  \hypersetup{colorlinks,allcolors=emphasis,urlcolor=url,
    pdftitle={Rédaction de thèses et mémoires avec LaTeX: Premiers pas},
...
%% Page titre; image dans fichier séparé
{
  \usebackgroundtemplate{%
    \includegraphics[page=1,height=\paperheight,width=\paperwidth]{%
      couvertures-diapos}}
  \frame[plain]{}
}
...
\end{lstlisting}
  ...
  \link{http://www.theses.ulaval.ca/wiki/}{WikiThèse UL}.
\end{frame}
...
\end{lstlisting}
      ...
      \begin{texample}[0.48\linewidth]
\begin{lstlisting}
Il m'a dit: «\emph{C'était
un peu \emph{rough} par
moments}»
\end{lstlisting}
        \producing
...
{
  \usebackgroundtemplate{%
    \includegraphics[page=2,height=\paperheight,width=\paperwidth]{couvertures-diapos}}
  \begin{frame}[plain]
