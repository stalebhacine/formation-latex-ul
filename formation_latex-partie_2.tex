\documentclass[letterpaper,11pt,x11names,english,french]{memoir}
  ...
  \usepackage{varioref}         % !!! nécessaire ?
  ...
  %% Étiquettes de \autoref (redéfinition compatible avec babel)
  \addto\extrasfrench{%
  ...
  %% Chapitres sur les bibliographies: des références bibliographiques
