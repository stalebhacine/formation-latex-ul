\documentclass[letterpaper,11pt,x11names]{memoir}
  ...
  %% Entrées et sorties LaTeX
  \newenvironment{texinput}[1]{%
    \begin{minipage}{#1}}{%
    \end{minipage}}
  \newenvironment{texoutput}[2][t]{%
    \begin{minipage}[#1]{#2}}{%
    \end{minipage}}
  ...
  \newenvironment{conseil}{%
    \begin{framed}%
      \noindent
      \begin{minipage}{0.1\linewidth}
        \raisebox{-1.5em}[0em][0em]{\HUGE\faThumbsUp}
      \end{minipage}
      \begin{minipage}[t]{0.88\linewidth}
  ...
  \newcommand{\doc}[3][documentation]{\link{#3}{#1}\marginpar{\faBook~\fichier{#2}}}
