\documentclass[letterpaper,11pt,x11names,english,french]{memoir}
  ...
  \lstset{language=[AlLaTeX]TeX,
    morekeywords={align,align*,aligned,cases,equation*,%
  ...
  \newcommand{\ixccmd}[1]{\index{#1@\string\toto{#1}}}
  \makeindex
...
%  \includeonly{frontispice,licence-partie_2}
...
\AddToShipoutPictureFG*{%
  \AtStockLowerLeft{\raisebox{45mm}{\includegraphics{codebarre}}}
}
