...
\begin{lstlisting}
\fbox{\begin{minipage}[b]{0.3\textwidth}
  La ligne inférieure de cette \emph{minipage} [...]
\end{minipage}}
\hfill
\fbox{\parbox{0.3\textwidth}{le centre de cette boîte [...] }}
\hfill
...
\begin{minipage}{\textwidth}
  ...
  \end{minipage}}
  \hfill
  \fbox{\parbox{0.3\textwidth}{le centre de cette boîte verticale, qui est à
    son tour alignée avec}}
  \hfill
  \fbox{\begin{minipage}[t]{0.3\textwidth}
    la ligne supérieure de cette \emph{minipage}. Le filet horizontal
    grisé représente la ligne de base de ce paragraphe.
  \end{minipage}}
\end{minipage}
\medskip
