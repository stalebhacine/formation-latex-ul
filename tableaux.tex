...
compléter l'élément. Le plus simple demeure de  d'abord esquisser un modèle au
...
\begin{center}
  \begin{picture}(15,9)
    ...
    \put(8.5,5){\makebox(5,1.5){pour les diagrammes}}
...
Il existe quelques outils pour tracer des figures plus complexes directement avec {\LaTeX}. Le
système Ti\emph{k}Z/\textsc{pgf} gagne beaucoup en popularité depuis
quelques années.
