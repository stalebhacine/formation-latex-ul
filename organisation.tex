...
\end{lstlisting}
  ...
  \begin{figure}
    \fbox{\includegraphics*[viewport=124 550 484 664,width=0.98\linewidth]{exemple-renvoi}}
...
\end{lstlisting}
  ...
  \begin{figure}
    \centering
    \fbox{\includegraphics[viewport=124 550 484 664,width=0.98\linewidth]{exemple-renvoi-hyperref}}
    \caption{Texte produit par le code de
...
\end{lstlisting}
  ...
  \begin{figure}
    \centering
    \fbox{\includegraphics[viewport=124 550 484 664,width=0.98\linewidth]{exemple-renvoi-autoref}}
    \caption{Texte produit par le code de
