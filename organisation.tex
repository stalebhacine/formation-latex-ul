...
comment spécifier la classe à utiliser. La présente section présente
les différences entre les classes ainsi que les principales options
disponibles.
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth,angle=-90]{tdm-dans-pdf}
...
\begin{exercice}[nosol]
  ...
  \item Ajouter un titre et un auteur au document à l'aide des
    commandes \cmprint{\title} et \cmdprint{\author} se trouvant déjà
    dans le préambule.
...
\begin{exercice}[nosol]
  ...
  \item Étudier le code source du fichier maître
    ...
    fois jusqu'à ce que tous les renvois soient à jour. Il est normal
    à ce stade que la figure~1 du document soit vide.
