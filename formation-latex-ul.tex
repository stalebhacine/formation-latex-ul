...
\documentclass[letterpaper,11pt,x11names,english,french]{memoir}
  ...
  %% Encadré avec titre basé sur titled-frame, ci-dessus.
  %% Arguments: couleur du cadre (optionnel; noir par défaut) et titre
  %% de la boite (obligatoire).
...
%  \includeonly{bases,presentation,boites}
