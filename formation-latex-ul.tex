\documentclass[letterpaper,11pt,x11names,english,french]{memoir}
  ...
  \hypersetup{colorlinks, linktocpage,
    ...
    pdftitle={Rédaction de thèses et mémoires avec LaTeX: Concepts avancés},
...
\include{presentation}       % tex et consorts; exercices 1 et 2
\include{base}               % principes de base du langage
\include{redaction}          % tout pour faire un document simple sans math
