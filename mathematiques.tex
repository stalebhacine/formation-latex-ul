...
\end{lstlisting}
  qui définissent un délimiteur gauche \meta{delim\_g} et un
  délimiteur droit \meta{delim\_d} dont la taille s'ajustera
...
\item Quand les choix de taille de délimiteurs de {\LaTeX} ne
  ...
  \cmd{\bigg} et %
  \cmd{\Bigg}. %
  Elles s'utilisent comme \cmdprint{\left} et \cmdprint{\right} en les
  faisant immédiatement suivre d'un délimiteur. Le
  \autoref{tab:math:big_et_al} contient des exemples de délimiteurs
  pour chaque taille.
  \begin{table}
    \centering
