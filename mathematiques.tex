...
moins de \nombre{5913} symboles répartis sur plus de 160 pages! On y
...
\item La %
  ...
  \autopageref{tab:math:binaires} ne
...
\end{lstlisting}
  ...
  On notera au passage que l'environnement \Ie{cases} de \pkg{amsmath}
...
\item À lire également: la section~14 de la %
  \doc[documentation]{amsldoc}{http://texdoc.net/pkg/amsmath} %
  de \pkg{amsmath} qui traite de divers enjeux typographiques en lien
