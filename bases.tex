...
\item On utilise des \emph{commandes} pour indiquer la structure du
  ...
  le caractère {\bs}. À la différence des logiciels de traitement de
...
\`\meta{nomcommande}
\end{lstlisting}
Dans ce cas, le nom de la commande se termine par tout caractère qui
...
les précéder par le caractère {\bs}:
\begin{demo}
...
\begin{exercice}
  ...
  \begin{sol}
    ...
    \item La commande {\LaTeX} qui imprime le logo de LaTeX n'ayant
      ...
      \verb={\LaTeX}\verb= ou \verb=\LaTeX{}= pour éviter que l'espace
