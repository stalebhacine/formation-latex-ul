\documentclass[letterpaper,11pt,x11names,english,french]{memoir}
  ...
  %% - \pixbsbs et \pixabang servent à afficher et indexer \\ et \!,
  %%   respectivement;
  %% - \pixbar sert à afficher et indexer \|, mais pour une raison que
  %%   j'ignore, l'entrée n'est pas traitée par hyperref.
  ...
  \makeatother
  \newcommand*{\pixbsbs}{\cmdprint{\\}\index{"\ @\string\cs{}\texttt{\textbackslash}}}
