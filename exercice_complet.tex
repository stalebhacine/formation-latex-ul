...
inspiré du S et de Scheme\index{Scheme}. Le S\index{S} était à son
...
R est \emph{interprété}\index{interprété (langage)}, c'est-à-dire
...
langages \emph{compilés}\index{compilé (langage)}, comme le C ou le
