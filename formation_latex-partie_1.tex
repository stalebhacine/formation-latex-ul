\documentclass[aspectratio=54,10pt,xcolor=x11names]{beamer}
  ...
  \newcommand{\ISBN}{XXX-XXXXXXX-X} % pour dépôt légal
...
%% Page titre; image dans fichier séparé
{
  \usebackgroundtemplate{%
    \includegraphics[height=\paperheight,width=\paperwidth]{couvertures-partie_1}}
  \begin{frame}[plain]
  \end{frame}
}
