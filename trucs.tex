...
%%% Certains mots-clés LaTeX présents dans le code C des exemples de
%%% cette section se retrouvent dans l'index, et ce, même si
%%% l'environnement lstlisting n'est pas celui qui est «actif». Pour
%%% contourner le problème, les mots-clés parasites sont supprimés ici
%%% et réintroduits à la fin de la section.
\lstset{language=[LaTeX]TeX, deletetexcs={int,include,begin,end}}
...
\lstset{language=[LaTeX]TeX, moretexcs={int,include,begin,end}}
...
\begin{exercice}
  ...
  \begin{sol}
    %%% Encore le problème de mots-clés parasites.
    \lstset{language=[LaTeX]TeX, deletetexcs={begin,end,ttfamily}}
...
\end{vglisting}
    ...
    %%% Réactivation des mots-clés
    \lstset{language=[LaTeX]TeX, moretexcs={begin,end,ttfamily}}
  \end{sol}
\end{exercice}
