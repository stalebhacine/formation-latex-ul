...
\item Utiliser une police OpenType ou TrueType présente sur son
  ...
  offrent toutefois un support approprié pour les mathématiques. La
  gestion des polices de caractères avec {\XeLaTeX} se fait avec le
  paquetage standard \pkg{fontspec}; consulter sa %
...
\end{lstlisting}
  ...
  On pourra utiliser la couleur \code{acier} directement dans les
...
section~6 de \citet{UL:latex:1}: le paquetage \pkg{hyperref}
...
Les utilisateurs du système statistique R bénéficient d'une mise
