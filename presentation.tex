\chapter{Présentation de {\TeX}, {\LaTeX} et consorts}
...
\link{http://www.xm1math.net/texmaker/index_fr.html}{texmaker}, %
\link{http://www.tug.org/texworks/}{TeXworks}, %
\link{http://www.texshop.org/}{TeXShop} (OS~X seulement), %
\link{http://www.winedt.com}{WinEdt} (Windows seulement), %
\link{http://kile.sourceforge.net}{Kile} (Linux), %
à peu près tous les bons éditeurs de texte pour programmeur.
...
\item Les formats les plus usuels sont pdf{\LaTeX} et {\XeLaTeX}. La
  classe \class{ulthese} les supporte tous deux.
...
\item Le moteur \code{xetex} peut utiliser directement les polices de
  caractères du système d'exploitation. On traite des polices de
  caractères plus en détail à la \autoref{trucs:polices}.
...
à peu près tout ce que vous êtes susceptible d'utiliser dans un
système {\TeX} est déjà installé.
