...
\begin{frame}[plain,fragile=singleslide]
  \begin{exercice}
    ...
    \item Ajouter du texte en français (avec accents) et observer le
      résultat.
    \item Compiler le document \fichier{exercice\_demo.tex}.
    \end{enumerate}
  \end{exercice}
\end{frame}
%%% <<<
...
\begin{frame}[plain,fragile=singleslide]
  ...
  \end{exercice}
  \begin{center}
    \fbox{\includegraphics[width=\linewidth]{exercice_commandes-solution}}
  \end{center}
\end{frame}
...
\begin{frame}[plain,fragile=singleslide]
  \begin{exercice}
    ...
    \item Insérer deux ou trois titres de sections de différents niveaux
      dans le document.
      \begin{itemize}
      \item[\faExclamationSign] Le premier niveau de section
          est \verb=\chapter= avec la classe \textbf{memoir}
      \end{itemize}
    \end{enumerate}
  \end{exercice}
\end{frame}
...
\end{lstlisting}
    ...
    \item lire la documentation de ce paquetage pour connaître toutes
      ses fonctionnalités
    \end{itemize}
  \item Décrire des équations mathématiques requiert un «language» spécial
    \begin{itemize}
