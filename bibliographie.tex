...
texte tel qu'il apparaît dans la bibliographie.
...
\item Les types d'entrées dans les exemples ci-dessus sont
  ...
  la \doc[documentation de {\BibTeX}]{btxdoc}{http://www.texdoc.org/pkg/btxdoc} %
...
\item {\BibTeX} gère normalement automatiquement les hauts et bas de
  ...
  la forme \code{\{\{TUG\}boat\}} pour éviter que {\BibTeX} ne le
...
\item {\BibTeX} ne supporte pas les lettres accentuées ou autres
  ...
  le tableau~17 de la %
  \doc[Comprehensive {\LaTeX} Symbol List]{comprehensive}{http://texdoc.net/pkg/comprehensive} %
  pour les accents.
...
\doc[versions
francisées]{}{http://mirrors.ctan.org/biblio/bibtex/contrib/bib-fr/} %
...
Le processus de création d'un document avec
